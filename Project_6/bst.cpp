...
void BinarySearchTree::InsertItem(ptrType &TreePtr, const treeItemType &NewItem,
                                  bool &Success) {
...
void BinarySearchTree::DeleteItem(ptrType &TreePtr, keyType SearchKey,
                                  bool &Success)
...
void BinarySearchTree::RetrieveItem(ptrType TreePtr, keyType SearchKey,
                                    treeItemType &TreeItem,
                                    bool &Success) const {
  if (TreePtr == NULL)
    Success = false; // empty tree
...
void BinarySearchTree::CopyTree(ptrType TreePtr, ptrType &NewTreePtr) const {
  // preorder traversal
...
ptrType BinarySearchTree::RootPtr() const { return Root; } // end RootPtr
...
void BinarySearchTree::Preorder(ptrType TreePtr, functionType Visit) {
  if (TreePtr != NULL) {
    Visit(TreePtr->Item);
...
void BinarySearchTree::Inorder(ptrType TreePtr, functionType Visit) {
  if (TreePtr != NULL) {
...
void BinarySearchTree::Postorder(ptrType TreePtr, functionType Visit) {
  if (TreePtr != NULL) {
